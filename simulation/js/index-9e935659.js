...
var fe = (t, n, e) =>
    n in t
        ...
        : (t[n] = e);
var gn = (t, n, e) => (fe(t, typeof n != "symbol" ? n + "" : n, e), e);
(function () {
...
function be(t) {
    typeof t == "function" ? (t = we(t)) : (t = Dn(t));
...
function Ce(t) {
    return this.select(t == null ? ke : $e(typeof t == "function" ? t : Bn(t)));
}
...
function Re(t) {
    return this.selectAll(
        t == null ? Ne : Pe(typeof t == "function" ? t : Bn(t))
    );
}
function Te(t) {
...
function Ae() {
    return new E(this._enter || this._groups.map(Hn), this._parents);
}
function Et(t, n) {
...
function De(t, n) {
    ...
    for (
        ...
        var u = r[l],
            ...
            U = (a[l] = new Array(f));
        e(u, h, m, I, U, p, n);
        for (var R = 0, T = 0, d, g; R < _; ++R)
            if ((d = m[R])) {
                for (R >= T && (T = R + 1); !(g = I[T]) && ++T < _;);
                d._next = g || null;
            }
    }
...
function Be() {
    return new E(this._exit || this._groups.map(Hn), this._parents);
}
function He(t, n, e) {
    var r = this.enter(),
        i = this,
...
function Q(t, n) {
    return (
        ...
        Xn(t).getComputedStyle(t, null).getPropertyValue(n)
    );
}
function ar(t) {
    return function () {
...
function vr(t) {
    return arguments.length
        ? this.each(t == null ? _r : (typeof t == "function" ? yr : mr)(t))
...
function Er(t) {
    return arguments.length
        ? this.each(t == null ? xr : (typeof t == "function" ? br : wr)(t))
        : this.node().innerHTML;
}
function $r() {
...
function Rr(t, n) {
    var e = typeof t == "function" ? t : On(t),
        r = n == null ? Pr : typeof n == "function" ? n : Zt(n);
    return this.select(function () {
...
function Xr(t, n, e) {
    ...
    for (c = n ? Hr : Br, i = 0; i < o; ++i) this.each(c(r[i], n, e));
    return this;
}
function Kn(t, n, e) {
    var r = Xn(t),
...
function qr(t, n) {
    return this.each((typeof n == "function" ? Vr : Fr)(t, n));
}
function* Yr() {
    for (var t = this._groups, n = 0, e = t.length; n < e; ++n)
...
function ut() {
    return new E([[document.documentElement]], Un);
}
function Kr() {
    return this;
}
...
function Wr(t) {
    var n = t.document.documentElement,
        e = b(t).on("dragstart.drag", W, ot);
    "onselectstart" in n
        ? e.on("selectstart.drag", W, ot)
...
function ni() {
    ...
    function p(d, g) {
        if (!(u || !t.call(this, d, g))) {
            ...
            y &&
                (b(d.view).on("mousemove.drag", _, ot).on("mouseup.drag", m, ot),
                    Wr(d.view),
                    St(d),
                    (l = !1),
                    (c = d.clientX),
    ...
    function I(d, g) {
        if (t.call(this, d, g)) {
            var y = d.changedTouches,
                ...
                z;
            for (G = 0; G < $; ++G)
                (z = T(this, v, d, g, y[G].identifier, y[G])) &&
                    (St(d), z("start", d, y[G]));
        }
    }
    function U(d) {
    ...
    return (
        (f.filter = function (d) {
            return arguments.length
                ? ((t = typeof d == "function" ? d : gt(!!d)), f)
                : t;
        }),
        (f.container = function (d) {
            return arguments.length
                ? ((n = typeof d == "function" ? d : gt(d)), f)
                : n;
        }),
        (f.subject = function (d) {
            return arguments.length
                ? ((e = typeof d == "function" ? d : gt(d)), f)
                : e;
        }),
        (f.touchable = function (d) {
            return arguments.length
                ? ((r = typeof d == "function" ? d : gt(!!d)), f)
                : r;
        }),
        (f.on = function () {
...
var st = 0.7,
    ...
    M = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
    ei = /^#([0-9a-f]{3,8})$/,
    ri = new RegExp(`^rgb\\(${Z},${Z},${Z}\\)$`),
    ii = new RegExp(`^rgb\\(${M},${M},${M}\\)$`),
    oi = new RegExp(`^rgba\\(${Z},${Z},${Z},${ct}\\)$`),
    si = new RegExp(`^rgba\\(${M},${M},${M},${ct}\\)$`),
    ci = new RegExp(`^hsl\\(${ct},${M},${M}\\)$`),
    ai = new RegExp(`^hsla\\(${ct},${M},${M},${ct}\\)$`),
    vn = {
        aliceblue: 15792383,
            ...
            : (n = ri.exec(t))
                ...
                : (n = ii.exec(t))
                    ...
                    : (n = oi.exec(t))
                        ? _t(n[1], n[2], n[3], n[4])
                        : (n = si.exec(t))
                            ? _t((n[1] * 255) / 100, (n[2] * 255) / 100, (n[3] * 255) / 100, n[4])
                            : (n = ci.exec(t))
                                ? kn(n[1], n[2] / 100, n[3] / 100, 1)
                                : (n = ai.exec(t))
                                    ? kn(n[1], n[2] / 100, n[3] / 100, n[4])
                                    : vn.hasOwnProperty(t)
                                        ? bn(vn[t])
                                        : t === "transparent"
                                            ? new w(NaN, NaN, NaN, 0)
...
function Xt(t, n, e, r) {
    return arguments.length === 1 ? fi(t) : new w(t, n, e, r ?? 1);
}
function w(t, n, e, r) {
...
Jt(
    ...
    zn(ft, {
        ...
        clamp() {
            return new w(q(this.r), q(this.g), q(this.b), kt(this.opacity));
        },
        displayable() {
            return (
                -0.5 <= this.r &&
...
function Wn(t) {
    ...
    if ((t instanceof ft || (t = at(t)), !t)) return new N();
...
function di(t, n, e, r) {
    return arguments.length === 1 ? Wn(t) : new N(t, n, e, r ?? 1);
}
function N(t, n, e, r) {
...
Jt(
    ...
    zn(ft, {
        ...
        clamp() {
            return new N(Cn(this.h), mt(this.s), mt(this.l), kt(this.opacity));
        },
        displayable() {
            return (
        ...
        formatHsl() {
            const t = kt(this.opacity);
            return `${t === 1 ? "hsl(" : "hsla("}${Cn(this.h)}, ${mt(this.s) * 100
                }%, ${mt(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
        },
    })
);
...
function vi(t, n) {
    var e = (Ft.lastIndex = Ot.lastIndex = 0),
        r,
        i,
        o,
        s = -1,
        c = [],
        a = [];
    for (t = t + "", n = n + ""; (r = Ft.exec(t)) && (i = Ot.exec(n));)
        (o = i.index) > e &&
...
function xi(t) {
    ...
    return n.isIdentity ? Vt : Jn(n.a, n.b, n.c, n.d, n.e, n.f);
}
function wi(t) {
    return t == null ||
...
function jn(t, n, e, r) {
    ...
    return function (l, u) {
        ...
        return (
            ...
            (l = u = null),
            function (p) {
                for (var _ = -1, m = f.length, I; ++_ < m;) h[(I = f[_]).i] = I.x(p);
                return h.join("");
            }
        );
    };
}
var bi = jn(xi, "px, ", "px)", "deg)"),
    Ei = jn(wi, ", ", ")", ")"),
    J = 0,
    tt = 0,
    j = 0,
...
function qt(t) {
    if (!J) {
        ...
        var n = t - Y;
        n > 24
            ? (t < 1 / 0 && (tt = setTimeout(Pn, t - lt.now() - Rt)),
                j && (j = clearInterval(j)))
            : (j || ((It = lt.now()), (j = setInterval(Ci, te))), (J = 1), ne(Pn));
    }
}
function Rn(t, n, e) {
    var r = new Nt();
...
var Ni = Wt("start", "end", "cancel", "interrupt"),
    Pi = [],
    re = 0,
    Tn = 1,
    Yt = 2,
        ...
        for (
            var u =
                l < e.duration
                    ...
                    : (e.timer.restart(a), (e.state = Kt), 1),
            h = -1,
            f = i.length;
            ++h < f;
            ...
            i[h].call(t, u);
        e.state === Kt && (e.on.call("end", t, t.__data__, e.index, e.group), a());
    }
    function a() {
...
function Li(t, n) {
    ...
    return this.each((n == null ? Mi : Si)(e, t, n));
}
function nn(t, n, e) {
    var r = t._id;
    return (
...
function Fi(t, n) {
    ...
    return this.attrTween(
        t,
        typeof n == "function"
            ? (e.local ? Xi : Hi)(e, r, nn(this, "attr." + t, n))
            : n == null
                ? (e.local ? Di : Oi)(e)
                : (e.local ? Bi : Gi)(e, r, n)
    );
...
function Ui(t, n) {
    ...
    var r = Pt(t);
    return this.tween(e, (r.local ? Yi : Ki)(r, n));
}
function zi(t, n) {
    return function () {
...
function Zi(t) {
    var n = this._id;
    return arguments.length
        ? this.each((typeof t == "function" ? zi : Wi)(n, t))
        : P(this.node(), n).delay;
}
function Qi(t, n) {
    return function () {
...
function no(t) {
    var n = this._id;
    return arguments.length ? this.each(to(n, t)) : P(this.node(), n).ease;
}
function eo(t, n) {
    return function () {
        var e = n.apply(this, arguments);
        ...
        for (var a = r[c], l = a.length, u, h = 0; h < l; ++h)
            if ((u = a[h])) {
                for (
                    ...
                    (p = f[m]) && Tt(p, n, e, m, f, _);
                o.push(f), s.push(u);
            }
    return new D(o, s, n, e);
}
var po = ut.prototype.constructor;
function go() {
...
function vo(t, n) {
    ...
    return function () {
        var a = S(this, t),
            l = a.on,
            u = a.value[o] == null ? c || (c = oe(n)) : void 0;
...
function xo(t, n, e) {
    ...
    return n == null
        ? this.styleTween(t, _o(t, r)).on("end.style." + t, oe(t))
        : typeof n == "function"
            ? this.styleTween(t, yo(t, r, nn(this, "style." + t, n))).each(
                vo(this._id, t)
            )
...
var So = { time: null, delay: 0, duration: 250, ease: Mo };
function Lo(t, n) {
...
function Oo(t) {
    ...
    t instanceof D
        ? ((n = t._id), (t = t._name))
        : ((n = se()), ((e = So).time = jt()), (t = t == null ? null : t + ""));
    for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var s = r[o], c = s.length, a, l = 0; l < c; ++l)
            (a = s[l]) && Tt(a, t, n, l, s, e || Lo(a, n));
    return new D(r, this._parents, t, n);
}
ut.prototype.interrupt = Ai;
ut.prototype.transition = Oo;
const Ut = Math.PI,
    zt = 2 * Ut,
    X = 1e-6,
    Do = zt - X;
...
class Bo {
        ...
        if (this._x1 === null) this._append`M${(this._x1 = n)},${(this._y1 = e)}`;
            ...
            if (!(Math.abs(h * a - l * u) > X) || !o)
                ...
                let p = r - s,
                    ...
                    U = Math.sqrt(m),
                    R = Math.sqrt(f),
                    T = o * Math.tan((Ut - Math.acos((m + f - I) / (2 * U * R))) / 2),
                    d = T / R,
                    g = T / U;
    ...
    arc(n, e, r, i, o, s) {
        ...
        this._x1 === null
            ...
            (f < 0 && (f = (f % zt) + zt),
                f > Do
                    ? this._append`A${r},${r},0,1,${h},${n - c},${e - a
...
function Fo(t) {
    return (n, e) => Xo(n, e).then((r) => new DOMParser().parseFromString(r, t));
}
const Vo = Fo("application/xml");
function et(t, n, e) {
...
const K = [
    ...
    rn = ["Vcc", "trig", "Echo", "gnd"],
    vt = { Vcc: "VCC", trig: "Trig", Echo: "Echo", gnd: "GND" },
    Yo = (t) => {
        ...
        if (this.connections.length % 2 === 0) {
            ...
            const e = V[this.connections[this.connections.length - 2].connector]
                ...
                : rt[this.connections[this.connections.length - 2].connector]
                    ? rt[this.connections[this.connections.length - 2].connector]
                    : vt[this.connections[this.connections.length - 2].connector]
                        ? vt[this.connections[this.connections.length - 2].connector]
                ...
                r = V[this.connections[this.connections.length - 1].connector]
                    ...
                    : rt[this.connections[this.connections.length - 1].connector]
                        ? rt[this.connections[this.connections.length - 1].connector]
                        : vt[this.connections[this.connections.length - 1].connector]
                            ? vt[this.connections[this.connections.length - 1].connector]
                            : this.connections[this.connections.length - 1].connector;
            (n.innerHTML = `Connection no. ${this.connections.length / 2
                }: ${e} to ${r}`),
...
const Mn = (t, n) => {
    ...
    zo = new ht("raspberry", x, "images/pi3dirk.svg", 1, !1, 0, 0),
    Wo = new ht(
        "OnekResistor",
        x,
    ...
    Qo = new ht("ultraSonicsensor", x, "images/sensor1.svg", 0.15, !1, 400, 0),
    Jo = new ht("box", x, "images/box.svg", 0.15, !0, 0, 0),
    on = x.append("g").attr("id", "pathsGroup"),
    dt = {
        rasberryPi:
    ...
    cn = document.getElementById("1kResistor"),
    an = document.getElementById("2kResistor"),
    ln = document.getElementById("sensor"),
    un = document.getElementById("object"),
    C = document.getElementById("componentDescription"),
    it = document.getElementById("displayInfo"),
    jo = document.getElementById("codeSubmit"),
    ts = document.getElementById("info"),
    ns = document.getElementById("list"),
    es = document.getElementById("undoButton");
sn.addEventListener("click", async () => await zo.load());
cn.addEventListener("click", () => Wo.load());
an.addEventListener("click", () => Zo.load());
ln.addEventListener("click", () => Qo.load());
un.addEventListener("click", async () => await Jo.load());
sn.addEventListener("mouseover", () => {
    (C.textContent = dt.rasberryPi), (C.style.display = "block");
});
cn.addEventListener("mouseover", () => {
    (C.textContent = dt.oneKResistor), (C.style.display = "block");
});
an.addEventListener("mouseover", () => {
    (C.textContent = dt.twoKResistor), (C.style.display = "block");
});
ln.addEventListener("mouseover", () => {
    (C.textContent = dt.sensor), (C.style.display = "block");
});
un.addEventListener("mouseover", () => {
    (C.textContent = dt.object), (C.style.display = "block");
});
[sn, cn, an, ln, un].forEach((t) => {
    t.addEventListener("mouseout", () => {
        (C.textContent = "Hover over a component to see its description."),
            (C.style.display = "none");
    });
});
let Dt = !1;
ts.addEventListener("click", () => {
    (Dt = !Dt), (ns.style.display = Dt ? "block" : "none");
});
const rs = () => {
    ...
    it.innerHTML = `Distance: ${i.toFixed(2)}`;
},
    Gt = (t) =>
        K.includes(t.srcElement.id) ||
        qo.includes(t.srcElement.id) ||
        en.includes(t.srcElement.id) ||
        rn.includes(t.srcElement.id);
let k;
const H = new Ko("connectionLog"),
    Ln = new Uo("errorBox", "errorHeading", "errorText", "closeErrorBox");
let O = 0;
es.addEventListener("click", () => {
    H.undoLastConnection(), os();
});
const is = (t) => {
    ...
    os = () => {
        if (k) {
            on.selectAll(`path[id^="path${O}"]`)
                .nodes()
                .forEach((e) => e.remove());
            const n = x.select(`#marker-start-${O}`);
            n.empty() || n.remove(),
                (k = null),
        ...
        if (H.connections.length > 0) {
            const t = H.connections[H.connections.length - 1],
                n = t.lineID,
            ...
            i.empty() || i.remove(),
                K.includes(t.connector) &&
                b(`#${t.connector}`).style("fill", "#9a916c"),
                t.connectorEnd &&
                K.includes(t.connectorEnd) &&
...
x.on("dblclick", (t) => {
    if (Gt(t) && !k) {
        (k = new Bo()),
            k.moveTo(t.offsetX, t.offsetY),
            K.includes(t.srcElement.id)
                ? b(`#${t.srcElement.id}`).style("fill", "black")
                : Sn(t.offsetX, t.offsetY, `marker-start-${O}`),
            H.addConnection({
                lineID: `path${O}`,
                x: t.offsetX,
                y: t.offsetY,
    ...
    if (t.srcElement.id === "svgContainer" && !Gt(t)) {
        k &&
            (k.lineTo(t.offsetX, t.offsetY),
                Mn(k.toString(), `path${O}`),
    ...
    if (Gt(t) && k) {
        k.lineTo(t.offsetX, t.offsetY),
            ...
            K.includes(t.srcElement.id)
                ? b(`#${t.srcElement.id}`).style("fill", "black")
                : Sn(t.offsetX, t.offsetY, `marker-end-${O}`),
            H.addConnection({
                lineID: `path${O}`,
                x: t.offsetX,
                y: t.offsetY,
...
x.on("mouseover", (t) => {
    K.includes(t.srcElement.id)
        ? (it.innerHTML = V[t.srcElement.id])
        : en.includes(t.srcElement.id)
            ? (it.innerHTML = rt[t.srcElement.id] || "Resistor Connector")
            : rn.includes(t.srcElement.id) &&
            (it.innerHTML = "Ultrasonic Sensor Connector");
});
x.on("mouseout", (t) => {
    (K.includes(t.srcElement.id) ||
        rn.includes(t.srcElement.id) ||
        en.includes(t.srcElement.id)) &&
        (it.innerHTML = "CONNECTOR INFO");
});
jo.addEventListener("click", () => {
    const t = Yo(H.getConnectionLog());
    t === !0
        ? (document.getElementById("box").addEventListener("mousemove", rs),
