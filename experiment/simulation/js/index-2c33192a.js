...
function Te(t) {
  return this.select(t == null ? Me : Pe(typeof t == "function" ? t : Fn(t)));
}
...
function Oe(t) {
  return this.selectAll(
    t == null ? Se : Le(typeof t == "function" ? t : Fn(t)),
  );
}
function Ge(t) {
...
function De() {
  return new k(this._enter || this._groups.map(qn), this._parents);
}
function Ct(t, n) {
...
function Ve(t, n) {
  ...
  for (
    ...
    var u = r[l],
      h = i[l],
      f = h.length,
      p = Fe(t.call(u, u && u.__data__, l, r)),
      _ = p.length,
      y = (c[l] = new Array(_)),
      N = (s[l] = new Array(_)),
      W = (a[l] = new Array(f));
    e(u, h, y, N, W, p, n);
    for (var T = 0, A = 0, d, m; T < _; ++T)
      if ((d = y[T])) {
        for (T >= A && (A = T + 1); !(m = N[A]) && ++A < _; );
        d._next = m || null;
      }
  }
  return ((s = new k(s, r)), (s._enter = c), (s._exit = a), s);
}
function Fe(t) {
  return typeof t == "object" && "length" in t ? t : Array.from(t);
}
function qe() {
  return new k(this._exit || this._groups.map(qn), this._parents);
}
function Ye(t, n, e) {
  var r = this.enter(),
    i = this,
...
function tt(t, n) {
  return (
    ...
    Yn(t).getComputedStyle(t, null).getPropertyValue(n)
  );
}
function pr(t) {
  return function () {
...
function Ur(t, n, e) {
  ...
  for (c = n ? Yr : qr, i = 0; i < o; ++i) this.each(c(r[i], n, e));
  return this;
}
function Qn(t, n, e) {
  var r = Yn(t),
...
function dt() {
  return new k([[document.documentElement]], Jn);
}
function Jr() {
  return this;
}
...
function jn() {
  ...
  function p(d, m) {
    if (!(u || !t.call(this, d, m))) {
      var w = A(this, n.call(this, d, m), d, m, "mouse");
      w &&
  ...
  function N(d, m) {
    if (t.call(this, d, m)) {
      var w = d.changedTouches,
        ...
        Z;
      for (H = 0; H < C; ++H)
        (Z = A(this, b, d, m, w[H].identifier, w[H])) &&
          (Gt(d), Z("start", d, w[H]));
    }
  }
  function W(d) {
    var m = d.changedTouches,
      ...
      C;
    for (b = 0; b < w; ++b)
      (C = i[m[b].identifier]) && (J(d), C("drag", d, m[b]));
  }
  function T(d) {
    var m = d.changedTouches,
      w = m.length,
    ...
    for (
      ...
      (C = i[m[b].identifier]) && (Gt(d), C("end", d, m[b]));
  }
  function A(d, m, w, b, C, H) {
    var Z = o.copy(),
      S = bn(H || w, m),
      gn,
      mn,
...
var lt = 0.7,
  ...
  li = new RegExp(`^rgb\\(${L},${L},${L}\\)$`),
  ui = new RegExp(`^rgba\\(${j},${j},${j},${ut}\\)$`),
  fi = new RegExp(`^rgba\\(${L},${L},${L},${ut}\\)$`),
  hi = new RegExp(`^hsl\\(${ut},${L},${L}\\)$`),
  di = new RegExp(`^hsla\\(${ut},${L},${L},${ut}\\)$`),
  En = {
    aliceblue: 15792383,
...
function Ft(t, n, e, r) {
  return arguments.length === 1 ? mi(t) : new $(t, n, e, r ?? 1);
}
function $(t, n, e, r) {
...
nn(
  ...
  te(pt, {
    ...
    clamp() {
      return new $(Y(this.r), Y(this.g), Y(this.b), Rt(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function ne(t) {
  ...
  if ((t instanceof pt || (t = ft(t)), !t)) return new P();
...
function yi(t, n, e, r) {
  return arguments.length === 1 ? ne(t) : new P(t, n, e, r ?? 1);
}
function P(t, n, e, r) {
...
nn(
  ...
  te(pt, {
    ...
    clamp() {
      return new P(Pn(this.h), wt(this.s), wt(this.l), Rt(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      const t = Rt(this.opacity);
      return `${t === 1 ? "hsl(" : "hsla("}${Pn(this.h)}, ${wt(this.s) * 100}%, ${wt(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
    },
  }),
);
function Pn(t) {
...
function ki(t) {
  ...
  return n.isIdentity ? Yt : ie(n.a, n.b, n.c, n.d, n.e, n.f);
}
function Ci(t) {
  return t == null ||
...
function oe(t, n, e, r) {
  ...
  function o(l, u, h, f, p, _) {
    if (l !== h || u !== f) {
      ...
      _.push({ i: y - 4, x: X(l, h) }, { i: y - 2, x: X(u, f) });
  ...
  return function (l, u) {
    ...
    return (
      ...
      (l = u = null),
      function (p) {
        for (var _ = -1, y = f.length, N; ++_ < y; ) h[(N = f[_]).i] = N.x(p);
        return h.join("");
      }
    );
  };
...
function Hi(t, n) {
  ...
  return this.each((n == null ? Di : Bi)(e, t, n));
}
function on(t, n, e) {
  var r = t._id;
  return (
...
function Ui(t, n) {
  ...
  return this.attrTween(
    t,
    typeof n == "function"
      ? (e.local ? Yi : qi)(e, r, on(this, "attr." + t, n))
      : n == null
        ? (e.local ? Ki : Xi)(e)
        : (e.local ? Fi : Vi)(e, r, n),
  );
...
function so(t) {
  var n = this._id;
  return arguments.length ? this.each(oo(n, t)) : M(this.node(), n).ease;
}
function co(t, n) {
  return function () {
    var e = n.apply(this, arguments);
...
var Bo = { time: null, delay: 0, duration: 250, ease: Do };
function Ho(t, n) {
    ...
    if (this._x1 === null) this._append`M${(this._x1 = n)},${(this._y1 = e)}`;
      ...
      if (!(Math.abs(h * a - l * u) > V) || !o)
        ...
        let p = r - s,
          ...
          W = Math.sqrt(y),
          T = Math.sqrt(f),
          A = o * Math.tan((Zt - Math.acos((y + f - N) / (2 * W * T))) / 2),
          d = A / T,
          m = A / W;
        (Math.abs(d - 1) > V && this._append`L${n + d * u},${e + d * h}`,
          this
            ._append`A${o},${o},0,0,${+(h * p > u * _)},${(this._x1 = n + m * a)},${(this._y1 = e + m * l)}`);
      }
  }
  arc(n, e, r, i, o, s) {
    ...
    (this._x1 === null
      ...
      r &&
        ...
        f > Ko
          ...
          : f > V &&
            this
              ._append`A${r},${r},0,${+(f >= Zt)},${h},${(this._x1 = n + r * Math.cos(o))},${(this._y1 = e + r * Math.sin(o))}`));
  }
  rect(n, e, r, i) {
    this
  ...
  logConnectionsToHtml() {
    if (this.connections.length % 2 === 0) {
      ...
      const e = q[this.connections[this.connections.length - 2].connector]
          ? `${q[this.connections[this.connections.length - 2].connector]} pin of Raspberry Pi`
        ...
        r = q[this.connections[this.connections.length - 1].connector]
          ? `${q[this.connections[this.connections.length - 1].connector]} pin of Raspberry Pi`
...
const Q = (E == null ? void 0 : E.offsetWidth) || window.innerWidth,
  jo =
    (E != null && E.offsetTop
  ...
  Gn = {
    ...
    mobile: {
      raspberry: { scale: 0.25, x: Q * 0.1, y: 30 },
...
const an = v.append("g").attr("id", "pathsGroup"),
  mt = {
    rasberryPi:
  ...
  R = document.getElementById("componentDescription"),
  ct = document.getElementById("displayInfo"),
  fs = document.getElementById("codeSubmit"),
  hs = document.getElementById("info"),
  ds = document.getElementById("list"),
  ps = document.getElementById("undoButton");
ln.addEventListener("click", async () => await ss.load());
un.addEventListener("click", () => cs.load());
fn.addEventListener("click", () => as.load());
hn.addEventListener("click", () => ls.load());
...
ln.addEventListener("mouseover", () => {
  ((R.textContent = mt.rasberryPi), (R.style.display = "block"));
});
un.addEventListener("mouseover", () => {
  ((R.textContent = mt.oneKResistor), (R.style.display = "block"));
});
fn.addEventListener("mouseover", () => {
  ((R.textContent = mt.twoKResistor), (R.style.display = "block"));
});
hn.addEventListener("mouseover", () => {
  ((R.textContent = mt.sensor), (R.style.display = "block"));
});
dn.addEventListener("mouseover", () => {
  ((R.textContent = mt.object), (R.style.display = "block"));
});
[ln, un, fn, hn, dn].forEach((t) => {
  t.addEventListener("mouseout", () => {
    ((R.textContent = "Hover over a component to see its description."),
      (R.style.display = "none"));
  });
});
let Ht = !1;
hs.addEventListener("click", () => {
  ((Ht = !Ht), (ds.style.display = Ht ? "block" : "none"));
});
const pn = (t) => {
...
v.on("mouseover", (t) => {
  z.includes(t.srcElement.id)
    ? (ct.innerHTML = q[t.srcElement.id])
    : sn.includes(t.srcElement.id)
